...
Notation "f '⁻¹'" := (@inverse_morphism _ _ _ f) (at level 7, no associativity) : morphism_scope.
...
Ltac simpl_isos_in_goal :=
  repeat(
      match goal with
        | [|- context[@iso_morphism _ _ _ ?A ∘ @inverse_morphism _ _ _ ?A]] => rewrite (@right_inverse _ _ _ A); simpl_ids
        | [|- context[@inverse_morphism _ _ _ ?A ∘ @iso_morphism _ _ _ ?A] ] => rewrite (@left_inverse _ _ _ A); simpl_ids
        | [|- context[@iso_morphism _ _ _ ?A] ] =>
          reveal_comp (@inverse_morphism _ _ _ A) (@iso_morphism _ _ _ A) +
          reveal_comp (@iso_morphism _ _ _ A) (@inverse_morphism _ _ _ A) 
      end
    )
.
...
Ltac simpl_isos_in_I I :=
  repeat(
      match type of I with
        | context[@iso_morphism _ _ _ ?A ∘ @inverse_morphism _ _ _ ?A] => rewrite (@right_inverse _ _ _ A) in I; simpl_ids in I
        | context[@inverse_morphism _ _ _ ?A ∘ @iso_morphism _ _ _ ?A] => rewrite (@left_inverse _ _ _ A) in I; simpl_ids in I
        | context[@inverse_morphism _ _ _ ?A] =>
          reveal_comp (@inverse_morphism _ _ _ A) (@iso_morphism _ _ _ A) in I +
          reveal_comp (@iso_morphism _ _ _ A) (@inverse_morphism _ _ _ A) in I
      end
    )
.
