...
Arguments Single {_ _ _ _ _} _.
Arguments Chain {_ _ _ _ _ _} _ _.
...
Theorem Compose_of_Chain_Compose `(C : Category Obj Hom) (a b c : Obj) (ch1 : Composable_Chain C a b) (ch2 : Composable_Chain C b c) : (Compose_of ch2)∘ (Compose_of ch1) = Compose_of (Chain_Compose ch1 ch2).
Proof.
  induction ch1; auto.
  simpl.
  rewrite <- assoc.
...
Theorem Forall_Links_Chain_Compose `(C : Category Obj Hom) (a b c : Obj) (ch1 : Composable_Chain C a b) (ch2 : Composable_Chain C b c) (P : ∀ (x y : Obj), Hom x y → Prop) : Forall_Links ch1 P → Forall_Links ch2 P → Forall_Links (Chain_Compose ch1 ch2) P.
Proof.
  intros H1 H2.
  induction ch1.
  simpl in *; auto.
