...
Local Hint Extern 1 =>
  progress (repeat (apply NatTrans_eq_simplify; FunExt); cbn in *) : core.
...
Section Left_Functor_Extender_Iso.
  ...
  Local Hint Extern 1 => (rewrite Trans_com); trivial; fail : core.
  Local Hint Extern 1 => rewrite <- F_compose : core.
  Local Hint Extern 1 =>
  match goal with
    [w : @Obj C |- _] =>
