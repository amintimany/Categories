...
From Categories Require Import Adjunction.Adjunction Adjunction.Univ_Morph.
From Categories.Adjunction.AFT Require Import Solution_Set_Cond
     Commas_Complete.Commas_Complete.
...
Section AFT.
  ...
  Context
    ...
    (SSC : ∀ x, Solution_Set_Cond (Comma (Const_Func 1 x) G)).
